...
dev1-start:
	INSTANCE_NAME=grb_local1 RIAK_HANDOFF_PORT=8199 TCP_LIST_PORT=7891 INTER_DC_PORT=8991 INTER_DC_RED_PORT=8992 $(BASEDIR)/$(DEV1RELPATH)/bin/$(ENVFILE) daemon

dev2-start:
	INSTANCE_NAME=grb_local2 RIAK_HANDOFF_PORT=8299 TCP_LIST_PORT=7892 INTER_DC_PORT=8993 INTER_DC_RED_PORT=8994 $(BASEDIR)/$(DEV2RELPATH)/bin/$(ENVFILE) daemon

dev3-start:
	INSTANCE_NAME=grb_local3 RIAK_HANDOFF_PORT=8399 TCP_LIST_PORT=7893 INTER_DC_PORT=8995 INTER_DC_RED_PORT=8996 $(BASEDIR)/$(DEV3RELPATH)/bin/$(ENVFILE) daemon

dev4-start:
	INSTANCE_NAME=grb_local4 RIAK_HANDOFF_PORT=8499 TCP_LIST_PORT=7894 INTER_DC_PORT=8997 INTER_DC_RED_PORT=8998 $(BASEDIR)/$(DEV4RELPATH)/bin/$(ENVFILE) daemon
