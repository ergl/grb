...
-spec visibility_table(partition_id()) -> cache_id().
...
init([Partition]) ->
    ...
    {ok, SampleEvery} = application:get_env(grb, visibility_sample_rate),
    ...
    State = #state{partition = Partition,
                   ...
                   visibility_sample_every=SampleEvery,
